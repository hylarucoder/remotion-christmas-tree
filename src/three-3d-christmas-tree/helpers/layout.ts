...
export const getPhoneLayout = (
  ...
  const screenPosition: Vector3 = [-screenWidth / 2, -screenHeight / 2, phoneThickness + Z_FLICKER_PREVENTION];
  ...
  const phoneRadius = screenRadius + (getPhoneWidth(aspectRatio, baseScale) - screenWidth) / 2;
